...
exports.fetch = function(count, max_id, cb) {
    var url = INSTAGRAM_API_URL + 'users/self/media/recent/?count=' + count + '&access_token=' + process.env.INSTAGRAM_ACCESS_TOKEN;
...
exports.user = function(cb) {
    ...
    var url = INSTAGRAM_API_URL + 'users/self?access_token=' + process.env.INSTAGRAM_ACCESS_TOKEN;
...
var INSTAGRAM_TOKEN_URL = 'https://api.instagram.com/oauth/access_token',
    INSTAGRAM_AUTH_REDIRECT_URL = 'http://localhost:4000/api/instagram/auth';
