...
exports.repos = function(cb) {
    ...
    var url = GITHUB_API_URL + 'users/' + process.env.GITHUB_USERNAME + '/repos?sort=updated';
...
exports.recentActivity = function(cb) {
    ...
    var url = GITHUB_API_URL + 'users/' + process.env.GITHUB_USERNAME + '/events/public';
    ...
    if (activity.type == 'CreateEvent') {
        ...
        if (activity.payload && activity.payload.forkee) {
            newActivity.description +=
                'to <a href="' + activity.payload.forkee.html_url + '" target="_blank">' + activity.payload.forkee.full_name + '</a>';
        }
        ...
        if (activity.payload.action == 'created') {
            ...
            if (activity.payload.repository) {
                newActivity.description +=
                    'at <a href="' + activity.payload.repository.html_url + '" target="_blank">' + activity.payload.repository.full_name + '</a> ';
            }
        ...
        if (activity.payload.release) {
            newActivity.description +=
                '<a href="' + activity.payload.release.html_url + '" target="_blank">' + activity.payload.release.tag_name + '</a> ';
        }
