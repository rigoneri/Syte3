...
exports.fetch = function(count, offset, cb) {
    var url = FOURSQUARE_API_URL + 'users/self/checkins?oauth_token=' + process.env.FOURSQUARE_ACCESS_TOKEN + '&v=20160520&limit=' + count;
...
exports.user = function(cb) {
    ...
    var url = FOURSQUARE_API_URL + 'users/self?oauth_token=' + process.env.FOURSQUARE_ACCESS_TOKEN + '&v=20160520';
...
var FOURSQUARE_TOKEN_URL = 'https://foursquare.com/oauth2/access_token',
    FOURSQUARE_AUTH_REDIRECT_URL = 'http://localhost:4000/api/foursquare/auth';
