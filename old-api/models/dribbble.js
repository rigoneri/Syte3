            ...
            exports.fetch(10, 0, function(err, posts) {
                ...
                if (!err && posts && posts.length > 0) {
                    ...
                    bulk.execute(function(err, result) {
                        if (err) {
                            console.log('Dribbble Bulk Error', err);
                        }
...
exports.fetch = function(count, page, cb) {
    var url = DRIBBBLE_API_URL + 'user/shots?access_token=' + process.env.DRIBBBLE_ACCESS_TOKEN + '&per_page=' + count;
...
exports.user = function(cb) {
    ...
    var url = DRIBBBLE_API_URL + 'user/?access_token=' + process.env.DRIBBBLE_ACCESS_TOKEN;
...
var DRIBBBLE_TOKEN_URL = 'https://dribbble.com/oauth/token',
    DRIBBBLE_AUTH_REDIRECT_URL = 'http://localhost:4000/api/dribbble/auth';
