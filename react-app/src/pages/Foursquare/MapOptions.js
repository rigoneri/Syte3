...
export const mapOptions = () => {
    ...
    return {
        ...
        styles: [
            ...
            { featureType: 'poi', elementType: 'geometry', stylers: [{ color: backgroundColor }, { lightness: '-9' }, { visibility: 'off' }] },
            ...
            { featureType: 'road.arterial', elementType: 'geometry', stylers: [{ color: lineColor }, { lightness: '6' }] },
            ...
            { featureType: 'transit', elementType: 'geometry', stylers: [{ color: backgroundColor }, { lightness: '-9' }] },
            {
                featureType: 'water',
